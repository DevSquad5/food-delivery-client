        ...
        <div className="row">
          <div className="col-lg-5">
            <div className="footer-logo">
              ...
              <p className="mb-0">
                {" "}
                <img src=".=/images/icon.png" alt="icon" /> House: 00, Road: 00,
                City-0000, Country{" "}
              </p>
              <p className="mb-0">
                {" "}
                <img src="/images/icon-2.png" alt="icon" /> admin@gmail.com{" "}
              </p>
              <p className="mb-0">
                {" "}
                <img src="/images/icon-3.png" alt="icon" /> 01300000000{" "}
              </p>
            </div>
          </div>
